  ...
  render() {
    ...
    return (
      <Container style={styles.container}>
				<Header hasTabs style={styles.IosBackground}>
					<Body>
				...
				{this.renderContent()}
				<Footer style={styles.IosBackground}>
					<FooterTab>
						<Button
							style={styles.button}
							active={this.state.activePageFirst}
							onPress={() => this.handleActivePageFirst()}>
							<Icon name='contacts' active={this.state.activePageFirst} size={25} style={{color:'#fff'}} />
						</Button>
						<Button
							style={styles.button}
							active={this.state.activePageSecond}
							onPress={() => this.handleActivePageSecond()}>
							<Icon name='chatboxes' active={this.state.activePageSecond} size={25} style={{color:'#fff'}} />
						</Button>
						<Button
							style={styles.button}
							active={this.state.activePageThird}
							onPress={() => this.handleActivePageThird()}>
							<Icon name='paper' active={this.state.activePageThird} size={25} style={{color:'#fff'}} />
						</Button>
						{/* <Button
							style={styles.button}
						...
						<Button
							...
							<Icon name='person' active={this.state.activePageFifth} size={25} style={{color:'#fff'}} />
						</Button>
					</FooterTab>
				</Footer>
			</Container>
