  ...
  render() {
  	...
  	if(this.state.openComment) {
          ...
          <View style={styles.comment}>
            <Content>
              <Input style={{paddingLeft:10, paddingRight: 10, fontSize: 14}} value={this.state.comment} onChangeText={(comment) => this.setState({comment})} placeholder='Write your comment...' />
            </Content>
  		...
  		<Container style={styles.container}>
  			<Content>
  				...
  				<View style={styles.viewNews}>
  					...
  					<Text style={{fontSize: 14, lineHeight: 22}}>{params.content}</Text>
  				</View>
  				<Card>
  					<CardItem>
  						<Left>
